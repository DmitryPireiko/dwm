...
static const char *fonts[]          = { "Ubuntu:size=10", "Font Awesome 6 Free Solid:size=12" };
...
static const char a_bg[]        = "#1A1B26";
static const char a_border[]    = "#000000";
static const char *colors[][3]  = {
	/*               fg         bg         border   */
	[SchemeNorm] = { ia_fg,    ia_bg,     ia_border },
	[SchemeSel]  = { a_fg,     a_bg,      a_border },
};
...
static const char *dmenucmd[] = { "dmenu" };
